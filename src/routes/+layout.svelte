<script lang="ts">
	...
	const navItems = [
		...
		},
		{
			href: "/arbitrage",
			label: "Arbitrage",
			icon: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z M7 13h10M7 17h5",
		},
		{
			href: "/customers",
			label: "Customers",
...
<div class="app-layout">
	...
	<nav class="bottom-nav">
		...
		<a
			href="/arbitrage"
			class="bottom-nav-item"
			class:active={currentPath.startsWith("/arbitrage")}
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
		...
		<a
			href="/customers"
			class="bottom-nav-item"
			class:active={currentPath.startsWith("/customers")}
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
		...
		<a
			href="/referral-tracker"
			class="bottom-nav-item"
			class:active={currentPath.startsWith("/referral-tracker")}
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
