...
export const BEHAVIOR_CONFIG: Record<BehaviorType, {
    ...
    hot_lead: {
        ...
        criteria: 'Volume >= 300,000 หรือ เทรด >= 5 ครั้ง'
    },
    negotiator: {
        emoji: '🎯',
        label: 'Negotiator',
        ...
        criteria: 'Volume > 0 หรือ เทรด >= 1 ครั้ง'
    },
    window_shopper: {
        emoji: '👀',
        ...
        criteria: 'มีประวัติการติดต่อ แต่ยังไม่มียอด Volume'
    },
    ghost: {
        emoji: '😶',
        label: 'Ghost',
        ...
        criteria: 'เคยเทรดแล้ว แต่เงียบหายไป > 14 วัน'
    },
    vip_repeat: {
        emoji: '💎',
        label: 'VIP Repeat',
        ...
        criteria: 'Volume >= 1,000,000 หรือ เทรด >= 15 ครั้ง'
    },
    new_prospect: {
        emoji: '🆕',
        label: 'New Prospect',
        ...
        criteria: 'ลูกค้าใหม่ที่เพิ่งเข้าระบบ'
    }
};
